...
Begin
  ...
  WriteLn ('|CR|07É|08Í[|15 B|07BS |15N|07ame |08]Í|07ÍÍÍÍÍÍÍÍÍÍÍ|08Í[|15 T|07yp |08]Í|07Í|08Í[|15 A|07dresse / |15T|07el.|08 ]Í|07ÍÍÍÍÍÍÍÍ|08Í[|15 S|07oftware|08 ]Í|07»')
  ...
  While Not fEof(ListFile) Do Begin
    ...
    If Not bbs_Deleted Then Begin
      ...
      WriteLn ('|08º |14' + PadRT(bbs_Name, 26, ' ') + '|09' + PadRT(BBSTyp, 8, ' ') + '|10' + PadRT(BBSAdresse,31, ' ') + '|12' + PadRT(bbs_Software, 11, ' ') + '|08º')
    End
  End;

  WriteLn ('|07ÈÍ|08ÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ|07Í¼|16|CR');
  fClose (ListFile)
